                    ...
                    <div class="p-3">
                        <div class="row">
                            <div class="col-9 col-lg-8 col-md-8 col-sm-9">
                                <div>
                                    <h3 class="mb-0 text-capitalize font-weight-bold" id="total_employee"></h3>
...
<script>
    ...
    async function totalEmployee() {
        showLoader();
        let res = await axios.get("/total-employee");
        hideLoader();
        document.getElementById('total_employee').innerHTML = res.data;
    }

    totalApp();
    async function totalApp() {
        showLoader();
        let res = await axios.get("/total-appication-manager");
        hideLoader();
    ...
    async function pendingAppication() {
        showLoader();
        let res = await axios.get("/pending-appication-manager");
        hideLoader();
